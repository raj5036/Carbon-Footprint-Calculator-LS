...
<?php  
    ...
    */ 
    ...
    //On form click run verify.php script
...
<?php
    ...
    $current_carbon_footprint=$user_entry->current_carbon_footprint;
    // echo $current_carbon_footprint;
    // echo $_SESSION['price'];
    
    // $current_carbon_footprint=180;
    
    // if($current_carbon_footprint < 1 )
    //     $price = $current_carbon_footprint*10;
    // else
    //     $price = $current_carbon_footprint*.50;
    ...
    $orderData = [
        //'receipt'         => 3456,
        'amount'          => ((int)$price) * 10, // 2000 rupees in paise
        'currency'        => 'INR',
    ...
    $_SESSION['carbon_percentage_reduced']=10;
    ...
    if ($displayCurrency !== 'INR')
    {
        ...
        $displayAmount = $exchange['rates'][$displayCurrency] * $amount / 200;
    }
      ...
      <div class="u-clearfix u-sheet u-valign-top-lg u-valign-top-md u-valign-top-sm u-valign-top-xl u-sheet-1">
        <div class="u-container-style u-expanded-width u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <p class="u-align-center u-text u-text-1">You are about to erase 10% of your annual footprint for</p>
            <h1 class="u-align-center u-text u-text-palette-2-base u-text-2">₹ <?php echo round($price*(10/100)); ?> </h1>
            ...
            <button name="submit" id="rzp-button1" class="u-active-palette-2-dark-3 u-align-center u-border-none u-btn u-btn-round u-button-style u-custom-color-1 u-custom-font u-font-montserrat u-hover-palette-2-dark-3 u-radius-8 u-text-active-white u-text-body-alt-color u-text-hover-white u-btn-1">Erase my&nbsp;Footprint</button>
