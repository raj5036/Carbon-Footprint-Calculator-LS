...
<div  style="width:100%;background-color:#F37421;padding:10px;font-size: 25px">
...
if(count($postmeta_list_result) > 0){
 ...
 echo "
<tr>
<td> Your Amount is Rs. ".($total_calculation_value * .50)."<br>
To offset your Carbon foot print click the pay now button below </td>
