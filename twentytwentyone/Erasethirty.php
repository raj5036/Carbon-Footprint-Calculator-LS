...
<?php
    ...
    $orderData = [
        //'receipt'         => 3456,
        'amount'          => round(((int)$price)) * 30, // 2000 rupees in paise
        'currency'        => 'INR',
    ...
    $_SESSION['carbon_percentage_reduced']=30;
      ...
      <div class="u-clearfix u-sheet u-valign-top-lg u-valign-top-md u-valign-top-sm u-valign-top-xl u-sheet-1">
        <div class="u-container-style u-expanded-width u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <p class="u-align-center u-text u-text-1">You are about to erase 30% of your annual footprint for</p>
            <h1 class="u-align-center u-text u-text-palette-2-base u-text-2">₹ <?php echo round($price*(30/100)); ?> </h1>
